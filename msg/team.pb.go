...
// @Function
// @Returns: TeamPhoto
type TeamUpdatePhoto struct {
	TeamID   int64          `protobuf:"varint,1,req,name=TeamID" json:"TeamID"`
	Document *InputDocument `protobuf:"bytes,2,req,name=Document" json:"Document,omitempty"`
}

func (m *TeamUpdatePhoto) Reset()         { *m = TeamUpdatePhoto{} }
func (m *TeamUpdatePhoto) String() string { return proto.CompactTextString(m) }
func (*TeamUpdatePhoto) ProtoMessage()    {}
func (*TeamUpdatePhoto) Descriptor() ([]byte, []int) {
	return fileDescriptor_8b4e9e93d7b2c6bb, []int{10}
}
func (m *TeamUpdatePhoto) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TeamUpdatePhoto) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TeamUpdatePhoto.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TeamUpdatePhoto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TeamUpdatePhoto.Merge(m, src)
}
func (m *TeamUpdatePhoto) XXX_Size() int {
	return m.Size()
}
func (m *TeamUpdatePhoto) XXX_DiscardUnknown() {
	xxx_messageInfo_TeamUpdatePhoto.DiscardUnknown(m)
}

var xxx_messageInfo_TeamUpdatePhoto proto.InternalMessageInfo

func (m *TeamUpdatePhoto) GetTeamID() int64 {
	if m != nil {
		return m.TeamID
	}
	return 0
...
func (m *TeamUpdatePhoto) GetDocument() *InputDocument {
	if m != nil {
		return m.Document
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*TeamUpdatePhoto)(nil), "msg.TeamUpdatePhoto")
...
var fileDescriptor_8b4e9e93d7b2c6bb = []byte{
	...
	,
}
...
func (m *TeamUpdatePhoto) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TeamUpdatePhoto) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TeamUpdatePhoto) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *TeamUpdatePhoto) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TeamUpdatePhoto) Unmarshal(dAtA []byte) error {
	var hasFields [1]uint64
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TeamUpdatePhoto: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TeamUpdatePhoto: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
