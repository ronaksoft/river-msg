...
type AccountPasswordSettings struct {
	...
	Questions []*SecurityQuestion `protobuf:"bytes,3,rep,name=Questions" json:"Questions,omitempty"`
}
...
func (m *AccountPasswordSettings) GetQuestions() []*SecurityQuestion {
	if m != nil {
		return m.Questions
	}
	return nil
...
type SecurityQuestion struct {
	ID         int32  `protobuf:"varint,1,req,name=ID" json:"ID"`
	Text       string `protobuf:"bytes,2,req,name=Text" json:"Text"`
	AnswerHash []byte `protobuf:"bytes,3,req,name=AnswerHash" json:"AnswerHash"`
}
...
func (m *SecurityQuestion) GetAnswerHash() []byte {
	if m != nil {
		return m.AnswerHash
	}
	return nil
...
type SecurityAnswer struct {
	...
	Answer     *InputPassword `protobuf:"bytes,2,req,name=Answer" json:"Answer,omitempty"`
}
...
func (m *SecurityAnswer) GetAnswer() *InputPassword {
	if m != nil {
		return m.Answer
	}
	return nil
...
var fileDescriptor_36a0c5dd1cea0696 = []byte{
	...
	,
}
...
func (m *SecurityQuestion) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.AnswerHash != nil {
		i -= len(m.AnswerHash)
		copy(dAtA[i:], m.AnswerHash)
		i = encodeVarintChatApiAccounts(dAtA, i, uint64(len(m.AnswerHash)))
		i--
		dAtA[i] = 0x1a
	}
	i -= len(m.Text)
...
func (m *SecurityAnswer) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Answer == nil {
		return 0, github_com_gogo_protobuf_proto.NewRequiredNotSetError("Answer")
	} else {
		{
...
func (m *SecurityQuestion) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AnswerHash", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AnswerHash = append(m.AnswerHash[:0], dAtA[iNdEx:postIndex]...)
			if m.AnswerHash == nil {
				m.AnswerHash = []byte{}
			}
			iNdEx = postIndex
	...
	if hasFields[0]&uint64(0x00000004) == 0 {
		return github_com_gogo_protobuf_proto.NewRequiredNotSetError("AnswerHash")
	}
