...
type ClientUsage struct {
	Year                  string `protobuf:"bytes,1,req,name=Year" json:"Year"`
	Month                 string `protobuf:"bytes,2,req,name=Month" json:"Month"`
	Day                   string `protobuf:"bytes,3,req,name=Day" json:"Day"`
	...
	ReceivedMessages      int64  `protobuf:"varint,7,opt,name=ReceivedMessages" json:"ReceivedMessages"`
	SentMessages          int64  `protobuf:"varint,8,opt,name=SentMessages" json:"SentMessages"`
	ReceivedMedia         int64  `protobuf:"varint,9,opt,name=ReceivedMedia" json:"ReceivedMedia"`
	SentMedia             int64  `protobuf:"varint,10,opt,name=SentMedia" json:"SentMedia"`
	ReceivedError         int64  `protobuf:"varint,11,opt,name=ReceivedError" json:"ReceivedError"`
	ReceivedInternalError int64  `protobuf:"varint,12,opt,name=ReceivedInternalError" json:"ReceivedInternalError"`
}
...
func (m *ClientUsage) GetYear() string {
	if m != nil {
		return m.Year
	}
	return ""
...
func (m *ClientUsage) GetMonth() string {
	if m != nil {
		return m.Month
	}
	return ""
...
func (m *ClientUsage) GetDay() string {
	if m != nil {
		return m.Day
	}
	return ""
...
func (m *ClientUsage) GetReceivedError() int64 {
	if m != nil {
		return m.ReceivedError
	}
	return 0
}

func (m *ClientUsage) GetReceivedInternalError() int64 {
	if m != nil {
		return m.ReceivedInternalError
	}
	return 0
}
...
func (*SystemDHGroups) Descriptor() ([]byte, []int) {
	return fileDescriptor_c566bdbff65da108, []int{16}
}
...
var fileDescriptor_c566bdbff65da108 = []byte{
	...
	,
}
...
func (m *ClientUsage) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	i = encodeVarintChatApiSystem(dAtA, i, uint64(m.ReceivedInternalError))
	i--
	dAtA[i] = 0x60
	i = encodeVarintChatApiSystem(dAtA, i, uint64(m.ReceivedError))
	i--
	dAtA[i] = 0x58
	...
	i -= len(m.Day)
	copy(dAtA[i:], m.Day)
	i = encodeVarintChatApiSystem(dAtA, i, uint64(len(m.Day)))
	i--
	dAtA[i] = 0x1a
	i -= len(m.Month)
	copy(dAtA[i:], m.Month)
	i = encodeVarintChatApiSystem(dAtA, i, uint64(len(m.Month)))
	i--
	dAtA[i] = 0x12
	i -= len(m.Year)
	copy(dAtA[i:], m.Year)
	i = encodeVarintChatApiSystem(dAtA, i, uint64(len(m.Year)))
	i--
	dAtA[i] = 0xa
	return len(dAtA) - i, nil
}
...
func (m *ClientUsage) Size() (n int) {
	...
	n += 1 + sovChatApiSystem(uint64(m.ReceivedError))
	n += 1 + sovChatApiSystem(uint64(m.ReceivedInternalError))
	return n
}
...
func (m *ClientUsage) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReceivedError", wireType)
			}
			m.ReceivedError = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ReceivedError |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 12:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReceivedInternalError", wireType)
			}
			m.ReceivedInternalError = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowChatApiSystem
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ReceivedInternalError |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
