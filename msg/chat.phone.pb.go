...
type PhoneRequestCall struct {
	...
	Participants []*PhoneParticipantSDP `protobuf:"bytes,4,rep,name=Participants" json:"Participants,omitempty"`
	CallID       int64                  `protobuf:"varint,5,opt,name=CallID" json:"CallID"`
}
...
type PhoneAcceptCall struct {
	...
	Participants []*PhoneParticipantSDP `protobuf:"bytes,3,rep,name=Participants" json:"Participants,omitempty"`
}
...
type PhoneDiscardCall struct {
	Peer         *InputPeer    `protobuf:"bytes,1,req,name=Peer" json:"Peer,omitempty"`
	CallID       int64         `protobuf:"varint,2,req,name=CallID" json:"CallID"`
	Participants []*InputUser  `protobuf:"bytes,3,rep,name=Participants" json:"Participants,omitempty"`
...
type PhoneActionRequested struct {
	SDP          string              `protobuf:"bytes,1,req,name=SDP" json:"SDP"`
	Type         string              `protobuf:"bytes,2,req,name=Type" json:"Type"`
	Participants []*PhoneParticipant `protobuf:"bytes,3,rep,name=Participants" json:"Participants,omitempty"`
}
...
type PhoneMediaSettingsUpdated struct {
	Video bool `protobuf:"varint,1,req,name=Video" json:"Video"`
	Audio bool `protobuf:"varint,2,req,name=Audio" json:"Audio"`
}
...
var fileDescriptor_d8b8a723e6958ad9 = []byte{
	...
	,
}
...
func (m *PhoneMediaSettingsUpdated) Unmarshal(dAtA []byte) error {
	...
	if hasFields[0]&uint64(0x00000002) == 0 {
		return github_com_gogo_protobuf_proto.NewRequiredNotSetError("Audio")
	}
