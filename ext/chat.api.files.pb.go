...
// FileGetMany
type FileGetMany struct {
	FileGetMany []*FileGet `protobuf:"bytes,1,rep,name=FileGetMany" json:"FileGetMany,omitempty"`
}

func (m *FileGetMany) Reset()         { *m = FileGetMany{} }
func (m *FileGetMany) String() string { return proto.CompactTextString(m) }
func (*FileGetMany) ProtoMessage()    {}
func (*FileGetMany) Descriptor() ([]byte, []int) {
	return fileDescriptor_05ced85bdf32a77a, []int{2}
}
func (m *FileGetMany) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *FileGetMany) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
...
func (m *FileGetMany) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FileGetMany.Merge(m, src)
}
func (m *FileGetMany) XXX_Size() int {
	return m.Size()
}
func (m *FileGetMany) XXX_DiscardUnknown() {
	xxx_messageInfo_FileGetMany.DiscardUnknown(m)
}

var xxx_messageInfo_FileGetMany proto.InternalMessageInfo

func (m *FileGetMany) GetFileGetMany() []*FileGet {
	if m != nil {
		return m.FileGetMany
	}
	return nil
}
...
type FileMany struct {
	FileMany []*File `protobuf:"bytes,1,rep,name=FileMany" json:"FileMany,omitempty"`
}

func (m *FileMany) Reset()         { *m = FileMany{} }
func (m *FileMany) String() string { return proto.CompactTextString(m) }
func (*FileMany) ProtoMessage()    {}
func (*FileMany) Descriptor() ([]byte, []int) {
	return fileDescriptor_05ced85bdf32a77a, []int{4}
}
func (m *FileMany) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *FileMany) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
...
func (m *FileMany) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FileMany.Merge(m, src)
}
func (m *FileMany) XXX_Size() int {
	return m.Size()
}
func (m *FileMany) XXX_DiscardUnknown() {
	xxx_messageInfo_FileMany.DiscardUnknown(m)
}

var xxx_messageInfo_FileMany proto.InternalMessageInfo

func (m *FileMany) GetFileMany() []*File {
	if m != nil {
		return m.FileMany
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*FileGetMany)(nil), "msg.FileGetMany")
	proto.RegisterType((*File)(nil), "msg.File")
	proto.RegisterType((*FileMany)(nil), "msg.FileMany")
}
...
var fileDescriptor_05ced85bdf32a77a = []byte{
	...
	,
}
...
func (m *FileGetMany) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FileGetMany: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FileGetMany: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FileGetMany", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.FileGetMany = append(m.FileGetMany, &FileGet{})
			if err := m.FileGetMany[len(m.FileGetMany)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *FileMany) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FileMany: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FileMany: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FileMany", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.FileMany = append(m.FileMany, &File{})
			if err := m.FileMany[len(m.FileMany)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
