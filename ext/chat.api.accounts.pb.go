...
const (
	LangCode_LangCodeUnknown LangCode = 0
	LangCode_LangCodeEn      LangCode = 1
	LangCode_LangCodeFa      LangCode = 2
)

var LangCode_name = map[int32]string{
	0: "LangCodeUnknown",
	1: "LangCodeEn",
	2: "LangCodeFa",
}

var LangCode_value = map[string]int32{
	"LangCodeUnknown": 0,
	"LangCodeEn":      1,
	"LangCodeFa":      2,
}
...
func (x LangCode) String() string {
	return proto.EnumName(LangCode_name, int32(x))
}

func (x *LangCode) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(LangCode_value, data, "LangCode")
	if err != nil {
		return err
	}
	*x = LangCode(value)
...
type AccountSetLang struct {
	LangCode LangCode `protobuf:"varint,1,req,name=LangCode,enum=msg.LangCode" json:"LangCode"`
}
...
func (m *AccountSetLang) GetLangCode() LangCode {
	if m != nil {
		return m.LangCode
	}
	return LangCode_LangCodeUnknown
}

func init() {
	proto.RegisterEnum("msg.LangCode", LangCode_name, LangCode_value)
...
var fileDescriptor_36a0c5dd1cea0696 = []byte{
	...
	,
}
...
func (m *AccountSetLang) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x8
	i++
	i = encodeVarintChatApiAccounts(dAtA, i, uint64(m.LangCode))
	return i, nil
}
...
func (m *AccountSetLang) Size() (n int) {
	...
	var l int
	_ = l
	n += 1 + sovChatApiAccounts(uint64(m.LangCode))
	return n
}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.LangCode |= LangCode(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
