...
type InputMediaWebDocument struct {
	...
	Size_      int32                `protobuf:"varint,2,req,name=Size" json:"Size"`
...
func (m *InputMediaWebDocument) GetSize_() int32 {
	if m != nil {
		return m.Size_
	}
	return 0
...
func (m *MediaWebDocument) GetSize_() int32 {
	if m != nil {
		return m.Size_
	}
	return 0
...
var fileDescriptor_313bfacbac33da31 = []byte{
	...
	,
}
...
func (m *InputMediaWebDocument) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	i--
	dAtA[i] = 0x1a
	i = encodeVarintChatCoreMessageMedias(dAtA, i, uint64(m.Size_))
	i--
	dAtA[i] = 0x10
	i -= len(m.Url)
	copy(dAtA[i:], m.Url)
...
func (m *InputMediaWebDocument) Size() (n int) {
	...
	l = len(m.Url)
	n += 1 + l + sovChatCoreMessageMedias(uint64(l))
	n += 1 + sovChatCoreMessageMedias(uint64(m.Size_))
	l = len(m.MimeType)
	n += 1 + l + sovChatCoreMessageMedias(uint64(l))
	if len(m.Attributes) > 0 {
		for _, e := range m.Attributes {
